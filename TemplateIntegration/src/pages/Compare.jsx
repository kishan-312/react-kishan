      ...
      <main class="main">
        <section class="breadcrumb">
          <ul class="breadcrumb__list flex container">
            ...
            <li>
              <span class="breadcrumb__link">Compare</span>
            </li>
          </ul>
        </section>
        ...
        <section class="compare container section--lg">
          <table class="compare__table">
            ...
            <tr>
              <th>Price</th>
              <td>
                <span class="table__price">$35</span>
              </td>
              <td>
                <span class="table__price">$67</span>
              </td>
              <td>
                <span class="table__price">$24</span>
              </td>
            </tr>
            <tr>
              <th>Description</th>
